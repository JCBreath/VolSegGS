...
class GaussianModel:
    ...
    def capture(self, include_feature=False):
        if include_feature:
            assert self._affinity_feature is not None, "No language feature"
            return (
    ...
    @property
    def get_affinity_feature(self):
        if self._affinity_feature is not None:
            return self._affinity_feature
        else:
            raise ValueError('No affinity feature')
    ...
    def _plane_regulation(self):
        ...
        for grids in multi_res_grids:
            if len(grids) == 3:
                ...
                if self.args.model_name == 'ViSNeRF':
                    time_grids = [0,1,2,3,4,5]
                else:
                    time_grids =  [0,1,3]
    ...
    def _l1_regulation(self):
        ...
        for grids in multi_res_grids:
            if len(grids) == 3:
                ...
                if self.args.model_name == 'ViSNeRF':
                    spatiotemporal_grids = [0,1,2,3,4,5,6]
                else:
