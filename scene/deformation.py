...
from scene.visnerf import ViSNeRF, MLP
...
class Deformation(nn.Module):
    def __init__(self, D=8, W=256, input_ch=27, input_ch_time=9, grid_pe=0, skips=[], args=None):
        ...
        if args.model_name == "ViSNeRF":
            self.grid = ViSNeRF(args.bounds, args.kplanes_config, args.multires)
        elif args.model_name == "MLP":
            self.grid = MLP(args.bounds, args.kplanes_config, args.multires)
        else:
